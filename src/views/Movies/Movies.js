...
export default class Movies extends Component {
  ...
  render() {
    const movies = this.state.movies.map((movie) => {
      return <Movie {...this.props} key={movie.movieId} movieData={movie} />;
    });
      ...
      <table>
        <thead>
          <tr>
            ...
            <th style={{ textAlign: "center" }}>ADD TO WATCH LIST</th>
    ...
    return (
      <Fragment>
        ...
        <div className="search">
          ...
          <button className="button" onClick={this.searchMovieButtonHandler}>
            SEARCH
          </button>
        </div>
        <div className="search">
          ...
          <button className="button" onClick={this.searchGenreButtonHandler}>
            SEARCH
          </button>
        </div>
